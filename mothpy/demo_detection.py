...
def concentration_array_demo(det,dt=0.01, t_max=3, draw_iter_interval=50):
    """
    ...
    conc_im = plt.imshow(conc_array.T, extent=im_extents, vmin=0, vmax=det,
                         cmap=cm.binary_r)
...
concentration_array_demo(30000)
concentration_array_demo(1500)
